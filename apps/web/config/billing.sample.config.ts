      ...
      plans: [
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XSiSIt7C5uWQXKh6x7DeS',
              name: 'Starter',
              cost: 9.99,
              type: 'flat' as const,
            },
        ...
        },
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XT1SIt7C5uWQXjLopoMy1',
              name: 'Base',
              cost: 99.99,
              type: 'flat' as const,
            },
      ...
      plans: [
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XTXSIt7C5uWQX5cH2UsIZ',
              name: 'Base',
              cost: 19.99,
              type: 'flat',
            },
        ...
        },
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XTuSIt7C5uWQXyFrUSqjX',
              name: 'Base',
              cost: 199.99,
              type: 'flat',
            },
      ...
      plans: [
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XUOSIt7C5uWQXGDDIFLAB',
              name: 'Base',
              cost: 29.99,
              type: 'flat',
            },
        ...
        },
        {
          ...
          lineItems: [
            {
              id: 'price_1S3XVoSIt7C5uWQXY93xoDxr',
              name: 'Base',
              cost: 299.9,
              type: 'flat',
            },
