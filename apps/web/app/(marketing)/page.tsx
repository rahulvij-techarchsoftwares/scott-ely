...
import { NewsletterSection } from '../../../../packages/ui/src/makerkit/marketing/newsletter';
import { FAQSection } from '../../../../packages/ui/src/makerkit/marketing/faqshow';
import { TeamSection } from '../../../../packages/ui/src/makerkit/marketing/team';
import { TestimonialSection } from '../../../../packages/ui/src/makerkit/marketing/testimonial';
function Home() {
  return (
    <div className={'mt-4 flex flex-col space-y-24 py-14'}>
          ...
          pill={
            <Pill label={'New'}>
              ...
              <PillActionButton asChild>
                <Link href={'/admin/dashboard/default'}>
      ...
      <div className={'container mx-auto'}>
            <div className="w-full ml-[50px] my-auto">
              <TestimonialSection/>
            </div>
