      ...
      <div className="max-w-(--breakpoint-sm) space-y-4 lg:space-y-8">
        <div className="space-y-4 text-center">
          ...
          <div className="text-muted-foreground">
            A finance dashboard is an admin panel that visualizes key financial data such as income,
            expenses, cash flow, budget, and profit.
          </div>
        </div>
        ...
        <Alert>
          ...
          <AlertDescription>This page is currently under construction.</AlertDescription>
        </Alert>
      </div>
    </div>
  );
